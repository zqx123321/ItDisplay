<%@ Page Title="" Language="C#" MasterPageFile="~/Display/Display.master" AutoEventWireup="true" CodeFile="Coursedianzi.aspx.cs" Inherits="Display_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="department">
        ...
        <h2>电子工程系</h2>
        <nav>
            <ul class="department-nav"><!--电子信息科学与技术</asp:ListItem>
        <asp:ListItem>电子信息工程</asp:ListItem>
        <asp:ListItem>通信工程-->
                <li class="active">电子信息科学与技术</li>
                <li>电子信息工程</li>
                <li>通信工程</li>
            </ul>
        </nav>
        ...
        <div class="specialty">
            ...
            <asp:Repeater ID="Repeater2" runat="server" ItemType="Course">
                <HeaderTemplate>
                    <ul>
                </HeaderTemplate>
                <ItemTemplate>
         ...
         <div class="specialty">
            ...
            <asp:Repeater ID="Repeater3" runat="server" ItemType="Course">
                <HeaderTemplate>
                    <ul>
                </HeaderTemplate>
                  <ItemTemplate>
